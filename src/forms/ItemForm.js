...
import Itemlogo from '../assets/images/samanico.png';
                ...
                <Row>
                    <Col xs={12} className="form">
                        <Form>
                            ...
                            <Form.Row>
                                <Field name={'name'} component={InputForm} label={'Room Number'} type={'text'} />
                            </Form.Row>
                            <Form.Row>
                                <Field name={'quantity'} component={InputForm} label={'Quantity'} type={'text'} />
                            </Form.Row>
                            <Form.Row>
                                <Field name={'unit'} component={InputForm} label={'Price (in Rs)'} type={'text'} />
                            </Form.Row>
                            <Form.Row>
                                <Field
                                    name={'categoryId'}
