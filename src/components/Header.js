...
import Logo from '../assets/images/core-inventory-logo.png';
                        ...
                        <React.Fragment>
                            <Navbar
                                ...
                                <Link to="/inventory" className="brand">
                                    <img src={Logo} alt="IIITL" width="175px" />
                                </Link>
                                <Navbar.Toggle aria-controls="basic-navbar-nav" />
                                <Navbar.Collapse id="basic-navbar-nav">
                                    <Nav className="mr-auto">
                                        <Nav.Link as={Link} to="/inventory" eventKey="0">Dashboard</Nav.Link>
                                        <Nav.Link as={Link} to="/categories" eventKey="1">Edit Categories</Nav.Link>
                                        <Nav.Link as={Link} to="/create-item" eventKey="2">Add item</Nav.Link>
                                    </Nav>
                                    <Button
